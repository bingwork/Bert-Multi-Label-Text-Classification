...
class BertProcessor(object):
    ...
    def get_labels(self):
        ...
        return ['ProductDomain_Education_Edtech', 'ProductDomain_Media_Broadcasting', 'ProductDomain_Media_Cinema',
                'ProductDomain_Media_DigitalMedia', 'ai', 'analytics', 'ar/vr', 'cad/plm',
                'collaboration & productivity', 'consulting', 'content management', 'crm', 'dev',
                'digital advertising', 'e-commerce', 'eda', 'embedded', 'energy', 'erp', 'fintech',
                'gaming', 'hardware', 'healthcare', 'hr', 'internet', 'iot', 'it infrastructure',
                'it management', 'marketplace', 'networking', 'saas', 'security', 'semiconductors',
                'social', 'storage', 'supply chain & logistics', 'unknown']
